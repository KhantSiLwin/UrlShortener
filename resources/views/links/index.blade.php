                ...
                <table class="min-w-full divide-y divide-gray-200">
                  <thead class="bg-gray-50 dark:bg-gray-600 dark:text-gray-200">
                    <tr>
                      ...
                      <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider">Shrot Url</th>
                      <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider">Visit</th>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                          <div class="flex justify-between">
                            <button class="bg-blue py-3 px-6">Edit</button>
                            <button class="bg-red">Delete</button>
                          </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">{{$link->created_at}}</td>
                      </tr> 
                    @endforeach
                    <!-- More items... -->
                  </tbody>
